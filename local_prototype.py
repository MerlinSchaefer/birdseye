...
#load model
try:
    learn_inf = load_learner(Path(f"C:/Users/ms101/OneDrive/DataScience_ML/projects/birds_classifier/App/{continents.get(habitat)}_first_34.pkl"))#load trained model
    learn_inf.model.cpu()
